...
$server = "AKOSUAPC\Akosua";
$server_user_name = "Akosua";
$server_password = "";

$database = "MaishaTest";

// connection to server
//$connect = mysql_connect($server, $server_user_name, $server_password);
//            $connect = mssql_connect($server, $server_user_name, $server_password);
$conne = mssql_connect($server);
...
$maisha_test_connect = mssql_select_db($database, $connect);

if (!$maisha_test_connect)
{

...
<head>
    ...
    <link rel="stylesheet" href="theBuzz.css">
...
<div class="top" >
    ...
    <table class="topCriteria" align="center" border='0' cellspacing ="0" style="background-color: black; padding: 0 7px 0 0 ; float: right" >
        <tbody>
        <tr>
            <td style="padding-right: 5em;">
                <table class="topCriteria" align="center" border='0' cellspacing ="0" style="/*background-color: black; margin: auto*/ float: right" >
                    <tbody>
                    <tr>
                        ...
                        <td class="catalogBorder" style="width: 90px; height: 22px; text-align: center;">
                            <a href="catalog.php" class="catalog" id="catalogI" >CATALOG</a>
                        </td>
            ...
            <td>
                <table class="searchButton" id="searchButtonI" align="center" border='0' cellspacing ="0">
                    <tbody>
                    <tr>
                        <td class="searchTD" style="width: 4em; text-align: right;" >
                            <form>
                                <input class="search" id="searchI" style=" " >
                            </form>
                        </td>
                        <td>
                        ...
                        <li><a href="" class="signIn" id="signInI"> SIGN IN </a>
                            <ul class="signInDropD">
                                <li><a href="#">username / email address
                                        <table class="usernameSignUp" align="center" border='0' cellspacing ="0" >
                                            <tbody>
                                            <tr>
                                ...
                                <li><a href="#">password
                                        <table class="passwordSignUpArea" align="center" border='0' cellspacing ="0" style="/*background-color: black; margin: auto;*/" >
                                            <tbody>
                                            <tr>
                                ...
                                <li><a href="#">LOGIN with
                                        <table class="loginWith" align="center" border='0' cellspacing ="0" style="/*background-color: black; margin: auto;*/" >
                                            <tbody>
                                            <tr>
                                ...
                                <li>
                                    <a href="#">
                                        <table class="go" align="right" border='0' cellspacing ="0" style="/*background-color: black; margin: auto;*/" >
                                            <tbody>
                                            <tr>
...
<div class="center" style="padding-top: 19em; text-align: center">
    ...
    <br>
    <table class="topCriteria" align="center" border='0' cellspacing ="0" style="/*background-color: black; margin: auto;*/" >
        <tbody>
        <!--                        <tr>
                                    <td style="width: 12em; text-align: center;" colspan = "2">
                                        <h1 class="maisha" id="maishaI" style="color: #971A2E;">Maisha</h1>
                                        <h4>Inspiring African art, photography and literature  </h4>
                                        <p><br></p>
                                    </td>
